...
@section('title', 'لوحة تحكم | قسم الإداريون')
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{ route('admin.admins.store') }}" method="POST" id="form_add">
                        @csrf
            ...
            <div class="card radius-10 w-100">
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table id="admins-table" class="table align-middle mb-0">
...
@section('js')
    <script>
        $(document).ready(function () {
            ...
            window.table = $('#admins-table').DataTable({
                processing: true,
                serverSide: true,
                ajax: {
