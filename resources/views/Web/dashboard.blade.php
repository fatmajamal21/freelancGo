        ...
        <div class="profile-content">
            <div class="profile-header">
                ...
                <div class="profile-info">
                    ...
                    <p class="profile-username"><i class="fas fa-user"></i> {{ $user->username }}</p>
                </div>
            ...
            <div class="profile-details">
                <div class="detail-card">
                    ...
                    <div class="detail-row">
                        ...
                        <div class="detail-value">{{ $user->created_at->format('Y-m-d') }}</div>
                    </div>

                    <div class="detail-row">
                        <div class="detail-label"><i class="fas fa-phone"></i> رقم الهاتف:</div>
                        <div class="detail-value">{{ $user->phone ?? 'غير مضاف' }}</div>
                    </div>
                </div>

                <div class="detail-card">
                    <h3 class="card-title"><i class="fas fa-file-alt"></i> الوصف الشخصي</h3>
                    <p class="project-desc">{{ $user->bio ?? 'لا يوجد وصف شخصي' }}</p>
                </div>
            </div>
        </div>
    </div>
